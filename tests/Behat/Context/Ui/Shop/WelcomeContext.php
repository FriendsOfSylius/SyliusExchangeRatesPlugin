...
namespace Tests\FriendsOfSylius\SyliusExchangeRatePlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\FriendsOfSylius\SyliusExchangeRatePlugin\Behat\Page\Shop\WelcomePageInterface;
